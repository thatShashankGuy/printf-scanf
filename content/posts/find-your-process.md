...
- 60%: Improving skills that provide immediate utility.

- 20%: Developing skills for future roles/aspirations.

- 20%: Exploring intriguing topics with no immediate practical use.
...
While learning can be gamified, I am not a fan. It quickly devolves into chasing scores and milestones. Beating records provides a dopamine hit, but people often start chasing the "hit" rather than the actual learning. A process is more reliable and lasting when it does not rely on dopamine spikes.
...
I will build upon this in 2026, implement these ideas, and _maybe_ write a follow-up article on the results.
